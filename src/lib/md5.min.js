...
*/
(function(A){function n(a,g){var b=(a&65535)+(g&65535);return(a>>16)+(g>>16)+(b>>16)<<16|b&65535}function k(a,g,b,p,k,h){a=n(n(g,a),n(p,h));return n(a<<k|a>>>32-k,b)}function h(a,g,b,p,h,l,m){return k(g&b|~g&p,a,g,h,l,m)}function l(a,g,b,p,h,l,m){return k(g&p|b&~p,a,g,h,l,m)}function m(a,g,b,h,l,m,n){return k(b^(g|~h),a,g,l,m,n)}function q(a,g){a[g>>5]|=128<<g%32;a[(g+64>>>9<<4)+14]=g;var b,p,u,v,q,c=1732584193,d=-271733879,e=-1732584194,f=271733878;for(b=0;b<a.length;b+=16)p=c,u=d,v=e,q=f,c=h(c,
...
d=m(d,e,f,c,a[b+13],21,1309151649),c=m(c,d,e,f,a[b+4],6,-145523070),f=m(f,c,d,e,a[b+11],10,-1120210379),e=m(e,f,c,d,a[b+2],15,718787259),d=m(d,e,f,c,a[b+9],21,-343485551),c=n(c,p),d=n(d,u),e=n(e,v),f=n(f,q);return[c,d,e,f]}function w(a){var g,b='';for(g=0;g<32*a.length;g+=8)b+=String.fromCharCode(a[g>>5]>>>g%32&255);return b}function r(a){var g,b=[];b[(a.length>>2)-1]=void 0;for(g=0;g<b.length;g+=1)b[g]=0;for(g=0;g<8*a.length;g+=8)b[g>>5]|=(a.charCodeAt(g/8)&255)<<g%32;return b}function x(a){return w(q(r(a),
8*a.length))}function y(a,g){var b,h=r(a),k=[],l=[];k[15]=l[15]=void 0;16<h.length&&(h=q(h,8*a.length));for(b=0;16>b;b+=1)k[b]=h[b]^909522486,l[b]=h[b]^1549556828;b=q(k.concat(r(g)),512+8*g.length);return w(q(l.concat(b),640))}function z(a){var g='',b,h;for(h=0;h<a.length;h+=1)b=a.charCodeAt(h),g+='0123456789abcdef'.charAt(b>>>4&15)+'0123456789abcdef'.charAt(b&15);return g}function t(a,g,b){g?b?a=y(unescape(encodeURIComponent(g)),unescape(encodeURIComponent(a))):(a=y(unescape(encodeURIComponent(g)),
unescape(encodeURIComponent(a))),a=z(a)):a=b?x(unescape(encodeURIComponent(a))):z(x(unescape(encodeURIComponent(a))));return a}'function'===typeof define&&define.amd?define(function(){return t}):'object'===typeof module&&module.exports?module.exports=t:A.md5=t})(this);
