...
(function($) {
    ...
    MediaElementPlayer.prototype.buildsourcechooser = function(player, controls, layers, media) {
        var t = this;
    ...
    MediaElementPlayer.prototype.addSourceButton = function(src, label, type, isCurrent) {
        var t = this;
    ...
    MediaElementPlayer.prototype.adjustSourcechooserBox = function() {
        var t = this;
