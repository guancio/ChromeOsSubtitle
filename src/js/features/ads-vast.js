...
(function($) {
    ...
    MediaElementPlayer.prototype.buildvast = function(player, controls, layers, media) {
        var t = this;
    ...
    MediaElementPlayer.prototype.vastSetupEvents = function() {
        var t = this;
    ...
    MediaElementPlayer.prototype.vastSetAdTagUrl = function(url) {
        var t = this;
    ...
    MediaElementPlayer.prototype.vastLoadAdTagInfo = function() {
    ...
    MediaElementPlayer.prototype.loadAdTagInfoDirect = function() {
    ...
    MediaElementPlayer.prototype.loadAdTagInfoProxy = function() {
    ...
    MediaElementPlayer.prototype.vastParseVastData = function(data) {
        var t = this;
    ...
    MediaElementPlayer.prototype.vastLoaded = function() {
        var t = this;
    ...
    MediaElementPlayer.prototype.vastStartPreroll = function() {
