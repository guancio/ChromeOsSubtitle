(function() {
    MediaElementPlayer.prototype.info = function() {
        var t = this,
            infoText = '<div class="mejs-window">' +
                            ...
                            '<ul>' +
                                ...
                                '<li>Subtitles service is powered by <a href="http://www.OpenSubtitles.org" target="_blank">www.OpenSubtitles.org</a>. More uploaded subs means more subs available. Please upload your subs.<br/><a href="http://www.OpenSubtitles.org" target="_blank"><img src="opensubtitle.gif"/></a></li>' +
                            '</ul><br>' +
                        '</div>',
            info = $(infoText)
        ...
        $('<div class="mejs-button mejs-info"><button type="button" title="' + chrome.i18n.getMessage('info') + '"></button></div>')
